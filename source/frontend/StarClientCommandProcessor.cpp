...
ClientCommandProcessor::ClientCommandProcessor(UniverseClientPtr universeClient, CinematicPtr cinematicOverlay,
  ...
  : m_universeClient(requireServiceValueAs<StarException>(std::move(universeClient), "ClientCommandProcessor", "universe client")),
    m_cinematicOverlay(requireServiceValueAs<StarException>(std::move(cinematicOverlay), "ClientCommandProcessor", "cinematic overlay")),
  ...
  m_builtinCommands = {
    ...
    {"whoami", [this](String const&) { return whoami(); }},
    {"gravity", [this](String const&) { return gravity(); }},
    {"debug", [this](String const& arg) { return debug(arg); }},
    {"boxes", [this](String const&) { return boxes(); }},
    {"fullbright", [this](String const&) { return fullbright(); }},
    {"asyncLighting", [this](String const&) { return asyncLighting(); }},
    {"setGravity", [this](String const& arg) { return setGravity(arg); }},
    {"resetGravity", [this](String const&) { return resetGravity(); }},
    {"fixedCamera", [this](String const&) { return fixedCamera(); }},
    {"monochromeLighting", [this](String const&) { return monochromeLighting(); }},
    {"radioMessage", [this](String const& arg) { return radioMessage(arg); }},
    {"clearRadioMessages", [this](String const&) { return clearRadioMessages(); }},
    {"clearCinematics", [this](String const&) { return clearCinematics(); }},
    {"startQuest", [this](String const& arg) { return startQuest(arg); }},
    {"completeQuest", [this](String const& arg) { return completeQuest(arg); }},
    {"failQuest", [this](String const& arg) { return failQuest(arg); }},
    {"previewNewQuest", [this](String const& arg) { return previewNewQuest(arg); }},
    {"previewQuestComplete", [this](String const& arg) { return previewQuestComplete(arg); }},
    {"previewQuestFailed", [this](String const& arg) { return previewQuestFailed(arg); }},
    {"clearScannedObjects", [this](String const&) { return clearScannedObjects(); }},
    {"played", [this](String const&) { return playTime(); }},
    {"deaths", [this](String const&) { return deathCount(); }},
    {"cinema", [this](String const& arg) { return cinema(arg); }},
    {"suicide", [this](String const&) { return suicide(); }},
    {"naked", [this](String const&) { return naked(); }},
    {"resetAchievements", [this](String const&) { return resetAchievements(); }},
    {"statistic", [this](String const& arg) { return statistic(arg); }},
    {"giveessentialitem", [this](String const& arg) { return giveEssentialItem(arg); }},
    {"maketechavailable", [this](String const& arg) { return makeTechAvailable(arg); }},
    {"enabletech", [this](String const& arg) { return enableTech(arg); }},
    {"upgradeship", [this](String const& arg) { return upgradeShip(arg); }},
    {"swap", [this](String const& arg) { return swap(arg); }},
    {"respawnInWorld", [this](String const& arg) { return respawnInWorld(arg); }},
    {"render", [this](String const& arg) { return render(arg); }}
  };
}
