...
public:
  ...
  [[nodiscard]] NpcDatabaseConstPtr const& npcDatabase() const;
  [[nodiscard]] MonsterDatabaseConstPtr const& monsterDatabase() const;
  [[nodiscard]] ProjectileDatabaseConstPtr const& projectileDatabase() const override;
  [[nodiscard]] SpawnTypeDatabaseConstPtr const& spawnTypeDatabase() const;
  [[nodiscard]] StagehandDatabaseConstPtr const& stagehandDatabase() const;
  [[nodiscard]] VehicleDatabaseConstPtr const& vehicleDatabase() const;
  [[nodiscard]] TerrainDatabaseConstPtr const& terrainDatabase() const;
  [[nodiscard]] BiomeDatabaseConstPtr const& biomeDatabase() const;
  [[nodiscard]] DungeonDefinitionsConstPtr const& dungeonDefinitions() const;
