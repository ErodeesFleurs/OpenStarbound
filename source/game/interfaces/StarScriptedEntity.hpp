...
public:
  ...
  [[nodiscard]] virtual Maybe<LuaValue> callScript(String const& func, LuaVariadic<LuaValue> const& args) = 0;

  // Execute the given code directly in the underlying context, return nothing
  // on failure.
  [[nodiscard]] virtual Maybe<LuaValue> evalScript(String const& code) = 0;
};
