...
public:
  ...
  [[nodiscard]] pair<UniquePtr<Root>, Options> initOrDie(StringList const& cmdLineArguments) const;

  pair<Root::Settings, Options> commandParseOrDie(int argc, char** argv);
  [[nodiscard]] pair<UniquePtr<Root>, Options> commandInitOrDie(int argc, char** argv);
