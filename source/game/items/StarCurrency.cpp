...
CurrencyItem::CurrencyItem(AssetsConstPtr assets, ImageMetadataDatabaseConstPtr imageMetadataDatabase, Json const& config, String const& directory) : Item(std::move(assets), std::move(imageMetadataDatabase), config, directory) {
