...
inline std::ostream& operator<<(std::ostream& os, Node const& node) {
  format(os, "Node{position = {}, velocity = {}}", node.position, node.velocity);
  return os;
}
...
inline std::ostream& operator<<(std::ostream& os, Edge const& edge) {
  format(os, "Edge{cost = {}, action = {}, jumpVelocity = {}, source = {}, target = {}}",
          edge.cost,
          edge.action,
          edge.jumpVelocity,
          edge.source,
...
template <> struct std::formatter<Star::PlatformerAStar::Node> : Star::OstreamFormatter {};
template <> struct std::formatter<Star::PlatformerAStar::Action> : Star::OstreamFormatter {};
template <> struct std::formatter<Star::PlatformerAStar::Edge> : Star::OstreamFormatter {};
