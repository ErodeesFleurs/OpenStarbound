...
NpcDatabase::NpcDatabase(AssetsConstPtr assets,
    ...
    : m_rebuilder(make_shared<Rebuilder>(requireServiceValueAs<NpcException>(assets, "NpcDatabase", "assets"), "npc", requireLuaRootServices(std::move(luaRootServices), "NpcDatabase"))),
      m_assets(requireServiceValueAs<NpcException>(std::move(assets), "NpcDatabase", "assets")),
      ...
      m_danceDatabase(requireServiceValueAs<NpcException>(std::move(danceDatabase), "NpcDatabase", "dance database")),
      m_emoteProcessor(requireServiceValueAs<NpcException>(std::move(emoteProcessor), "NpcDatabase", "emote processor")),
