...
Mutex::Mutex() : m_impl(make_unique<MutexImpl>()) {}
...
ConditionVariable::ConditionVariable() : m_impl(make_unique<ConditionVariableImpl>()) {}
...
RecursiveMutex::RecursiveMutex() : m_impl(make_unique<RecursiveMutexImpl>()) {}
