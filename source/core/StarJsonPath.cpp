...
auto parsePointer(String& buffer, String const& path, String::const_iterator& iterator, String::const_iterator end) -> TypeHint {
  buffer.clear();
...
auto parseQueryPath(String& buffer, String const& path, String::const_iterator& iterator, String::const_iterator end) -> TypeHint {
  buffer.clear();
