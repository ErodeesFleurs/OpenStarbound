...
struct DataStreamExceptionTag {
  static constexpr char const* name() { return "DataStreamException"; }
};
using DataStreamException = StarError<DataStreamExceptionTag, IOException>;
