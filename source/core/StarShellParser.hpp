...
struct ShellParsingExceptionTag {
  static constexpr char const* name() { return "ShellParsingException"; }
};
using ShellParsingException = StarError<ShellParsingExceptionTag, StarException>;
