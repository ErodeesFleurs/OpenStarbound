...
LuaCallbacks LuaBindings::makeRenderingCallbacks(ClientApplication* app) {
  ...
  callbacks.registerCallbackWithSignature<void, String, bool, std::optional<bool>>("setPostProcessGroupEnabled", bind(mem_fn(&ClientApplication::setPostProcessGroupEnabled), app, _1, _2, _3));
