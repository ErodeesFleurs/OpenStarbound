...
--- @param identity any
---@param humanoidParameters any
---@param humanoidConfig table
---@param npcHumanoidConfig any
function build(identity, humanoidParameters, humanoidConfig, npcHumanoidConfig)
    ...
    for i, bodyState in ipairs(bodyStates) do
        ...
        setPath(stateTypes, { "bodyHighPriority", "states", bodyState, "cycle" },
            humanoidConfig.humanoidTiming.stateCycle[i])
    ...
    humanoidConfig.identityFramesetTags = humanoidConfig.identityFramesetTags or
        root.assetJson("/humanoid.config:identityFramesetTags")

    setPath(parts, { "anchor", "properties", "offset" }, vecTilePixels(humanoidConfig.globalOffset))
    setPath(parts,
        { humanoidConfig.mouthOffsetPart or "head", "properties", humanoidConfig.mouthOffsetPartPoint or "mouthOffset" },
        vecTilePixels(humanoidConfig.mouthOffset))
    setPath(parts,
        { humanoidConfig.feetOffsetPart or "body", "properties", humanoidConfig.feetOffsetPartPoint or "feetOffset" },
        vecTilePixels(humanoidConfig.feetOffset))

    setPath(parts,
        { humanoidConfig.headArmorOffsetPart or "headCosmetic", "properties", humanoidConfig.headArmorOffsetPartPoint or
        "armorOffset" }, vecTilePixels(humanoidConfig.headArmorOffset))
    setPath(parts,
        { humanoidConfig.chestArmorOffsetPart or "chestCosmetic", "properties", humanoidConfig.chestArmorOffsetPartPoint or
        "armorOffset" }, vecTilePixels(humanoidConfig.chestArmorOffset))
    setPath(parts,
        { humanoidConfig.legsArmorOffsetPart or "legsCosmetic", "properties", humanoidConfig.legsArmorOffsetPartPoint or
        "armorOffset" }, vecTilePixels(humanoidConfig.legsArmorOffset))
    setPath(parts,
        { humanoidConfig.backArmorOffsetPart or "backCosmetic", "properties", humanoidConfig.backArmorOffsetPartPoint or
        "armorOffset" }, vecTilePixels(humanoidConfig.backArmorOffset))

    setPath(parts,
        { humanoidConfig.frontArmRotationPart or "frontArm", "properties", humanoidConfig.frontArmRotationPartPoint or
        "rotationCenter" }, vecTilePixels(humanoidConfig.frontArmRotationCenter))
    setPath(parts,
        { humanoidConfig.backArmRotationPart or "backArm", "properties", humanoidConfig.backArmRotationPartPoint or
        "rotationCenter" }, vecTilePixels({
    ...
    setPath(parts, { humanoidConfig.frontHandItemPart or "frontHandItem", "properties", "offset" },
        vecTilePixels(humanoidConfig.frontHandPosition))
    ...
    setPath(parts,
        { humanoidConfig.headRotationPart or "head", "properties", humanoidConfig.headRotationPartPoint or
        "rotationCenter" },
