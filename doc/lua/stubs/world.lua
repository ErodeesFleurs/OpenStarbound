...
---@param collisionKinds CollisionSet
---@return Optional<Vec2F>, Optional<Vec2F>
...
---@param endPoint Vec2F
---@param collisionKinds CollisionSet
---@return Optional<Pair<Vec2F, Vec2F>>
...
---@param startPoint Vec2F
---@param endPoint Vec2F
---@return List<Pair<Vec2I, integer>>
...
---@param searchParameters PlatformerAStar_Parameters
---@return PlatformerAStar_Path
...
---@param movementParameters ActorMovementParameters
---@param searchParameters PlatformerAStar_Parameters
---@return PlatformerAStar_PathFinder
...
---@param sourceEntity integer
---@return boolean
function world.damageTileArea(center, radius, layerName, sourcePosition, damageType, damageAmount, harvestLevel,
                              sourceEntity)
...
---@param dungeonId integer
---@param breathable Optional<boolean>
