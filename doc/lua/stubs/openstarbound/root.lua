...
---@param genderChoice integer
---@param bodyColorChoice integer
---@param alty integer
---@param hairChoice integer
---@param heady integer
---@param shirtChoice integer
---@param shirtColor integer
---@param pantsChoice integer
---@param pantsColor integer
---@param personality integer
---@param ext ...any
---@return Json, JsonObject, JsonObject
function root.createHumanoid(name, speciesChoice, genderChoice, bodyColorChoice, alty, hairChoice, heady, shirtChoice,
                             shirtColor, pantsChoice, pantsColor, personality, ext)
